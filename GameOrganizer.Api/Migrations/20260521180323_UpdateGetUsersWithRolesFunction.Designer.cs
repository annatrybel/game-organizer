...
namespace GameOrganizer.Api.Migrations
{
    ...
    [Migration("20260521180323_UpdateGetUsersWithRolesFunction")]
    partial class UpdateGetUsersWithRolesFunction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameOrganizer.Api.Models.DatabaseModels.ChatGroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameOrganizer.Api.Models.DatabaseModels.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameOrganizer.Api.Models.DatabaseModels.UserRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameOrganizer.Api.Models.DatabaseModels.ChatGroupMember", b =>
                {
                    b.HasOne("GameOrganizer.Api.Models.DatabaseModels.ChatGroup", "ChatGroup")
                        .WithMany("Members")
