...
{
    /// <inheritdoc />
    public partial class UpdateGetUsersWithRolesFunction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"CREATE OR REPLACE FUNCTION public.get_users_with_roles(search_value text DEFAULT NULL::text, sort_column text DEFAULT 'UserName'::text, sort_direction text DEFAULT 'ASC'::text)
 RETURNS TABLE(userid text, username character varying, email character varying, roleid text, rolename character varying, islocked boolean,  avatarurl text, bio text, invitationcode text )
 LANGUAGE plpgsql
AS $function$
BEGIN
    RETURN QUERY
